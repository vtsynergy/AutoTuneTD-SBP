...
| Example Graph | Recommended Configuration<br>`alpha = 0`<br><sub>Performance</sub> | Recommended Configuration<br>`alpha = 0.5`<br><sub>Balanced</sub> | Recommended Configuration<br>`alpha = 1`<br><sub>Accuracy</sub> |
| --- | --- | --- | --- |
| CAIDA<br>`20220114-`<br>`000000` | **Recommended Configuration 24**<br>One-parameter change from Configuration 1:<br>`NONPARAMETRIC=0`<br><sub>Full configuration:</sub><br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=0, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Recommended Configuration 22**<br>One-parameter change from Configuration 1:<br>`MH_PERCENT=1.0`<br><sub>Full configuration:</sub><br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=1.0, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Recommended Configuration 21**<br>One-parameter change from Configuration 1:<br>`MH_PERCENT=0.9`<br><sub>Full configuration:</sub><br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.9, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> |
| MIT Graph Challenge<br>`static_lowOverlap_`<br>`highBlockSizeVar_`<br>`20000000_nodes` | **Recommended Configuration 12**<br>One-parameter change from Configuration 1:<br>`SPLIT=single-snowball`<br><sub>Full configuration:</sub><br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=single-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Recommended Configuration 9**<br>One-parameter change from Configuration 1:<br>`SPLITINIT=degree-weighted`<br><sub>Full configuration:</sub><br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=degree-weighted, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Recommended Configuration 1**<br>Reference configuration<br><sub>Full configuration:</sub><br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> |
