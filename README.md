...
We are also extending AutoTuneTD-SBP to two-parameter perturbations. Varying pairs of parameters with nonzero measured contribution expands the candidate set from 27 to 255 configurations, about a `9.4x` expansion.

| Graph | `alpha = 0` | `alpha = 0.5` | `alpha = 1` |
| --- | --- | --- | --- |
| CAIDA<br>`20220114-`<br>`000000` | **Configuration 24**<br>`SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=0, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0`<br>*(Main change: `NONPARAMETRIC=0`.)* | **Configuration 22**<br>`SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=1.0, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0`<br>*(Main change: `MH_PERCENT=1.0`.)* | **Configuration 21**<br>`SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.9, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0`<br>*(Main change: `MH_PERCENT=0.9`.)* |
| MIT Graph Challenge<br>`static_lowOverlap_`<br>`highBlockSizeVar_`<br>`20000000_nodes` | **Configuration 12**<br>`SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=single-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0`<br>*(Main change: `SPLIT=single-snowball`.)* | **Configuration 9**<br>`SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=degree-weighted, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0`<br>*(Main change: `SPLITINIT=degree-weighted`.)* | **Configuration 1**<br>`SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0`<br>*(Reference configuration.)* |

See the [CAIDA results](Results/CAIDA/README.md) and [MIT Graph Challenge results](Results/MGC/README.md) for additional details.
