...
| --- | --- | --- | --- |
| CAIDA<br>`20220114-`<br>`000000` | **Configuration 24**<br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=0, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Configuration 22**<br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=1.0, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Configuration 21**<br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.9, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> |
| MIT Graph Challenge<br>`static_lowOverlap_`<br>`highBlockSizeVar_`<br>`20000000_nodes` | **Configuration 12**<br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=single-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | <br>**Configuration 9**<br> <sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=degree-weighted, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> | **Configuration 1**<br><sub><code>SUBGRAPHS=2, BATCHES=2, CACHE_SIZE=20000, DEGREEPRODUCTSORT=1, SPLITINIT=random, SPLIT=connectivity-snowball, MH_PERCENT=0.1, ALGORITHM=hybrid_mcmc, OVERLAP=unk, NONPARAMETRIC=1, NODELTA=0, MIX=0, GREEDY=0, APPROXIMATE=0, ASYNC_ITERS=0</code></sub> |
